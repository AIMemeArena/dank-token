...
export interface DankTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface DankToken extends BaseContract {
  connect(runner?: ContractRunner | null): DankToken;
  waitForDeployment(): Promise<this>;

  interface: DankTokenInterface;
  ...
  >;
  getEvent(
    key: "TokenInitialized"
  ): TypedContractEvent<
    TokenInitializedEvent.InputTuple,
    TokenInitializedEvent.OutputTuple,
    TokenInitializedEvent.OutputObject
  >;
  getEvent(
    key: "Transfer"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "TokenInitialized(string,string,uint256,address)": TypedContractEvent<
      TokenInitializedEvent.InputTuple,
      TokenInitializedEvent.OutputTuple,
      TokenInitializedEvent.OutputObject
    >;
    TokenInitialized: TypedContractEvent<
      TokenInitializedEvent.InputTuple,
      TokenInitializedEvent.OutputTuple,
      TokenInitializedEvent.OutputObject
    >;
